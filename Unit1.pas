...
begin
  Edit3.Clear;
  Edit3.Text := Somar(StrToFloat(Edit1.Text), StrToFloat(Edit1.Text));
end;
...
begin
  Edit3.Clear;
  Edit3.Text := Subtrair(StrToFloat(Edit1.Text), StrToFloat(Edit1.Text));
end;
...
begin
  Edit3.Clear;
  Edit3.Text := Multiplicar(StrToFloat(Edit1.Text), StrToFloat(Edit1.Text));
end;
...
begin
  Edit3.Clear;
  Edit3.Text := Dividir(StrToFloat(Edit1.Text), StrToFloat(Edit1.Text));
end;
